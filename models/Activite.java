...
public class Activite {
    ...
    public Activite(int id_activite, Timestamp date_activite, int id_exercice, int duree_minutes, int calories_brulees, int nb_series, int nb_repetitions, float poids, String notes) {
    ...
    public Activite(Timestamp date_activite, int id_exercice, int duree_minutes, int calories_brulees, int nb_series, int nb_repetitions, float poids, String notes) {
        this.date_activite = date_activite;
        this.id_exercice = id_exercice;
        this.duree_minutes = duree_minutes;
        this.calories_brulees = calories_brulees;
