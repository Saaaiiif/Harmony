...
public class MyDataBase {
     ...
     */
    public static class SceneTransitionUtil {
        ...
        public static <T> T changeScene(Scene currentScene, String fxmlPath, TransitionType transitionType, Class<T> controller) throws IOException {
            ...
            newScene.getStylesheets().add(Objects.requireNonNull(SceneTransitionUtil.class.getResource("/styles.css")).toExternalForm());
