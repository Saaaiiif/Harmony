...
public class Consommation {
    ...
    public Consommation(int id_consommation, int user_id, Timestamp date_consommation, String type_repas, int id_aliment, int quantite_eau_ml, int poids_grammes) {
    ...
    public Consommation(int user_id, Timestamp date_consommation, String type_repas, int id_aliment, int quantite_eau_ml, int poids_grammes) {
        this.user_id = user_id;
        this.date_consommation = date_consommation;
        this.type_repas = type_repas;
        this.id_aliment = id_aliment;
