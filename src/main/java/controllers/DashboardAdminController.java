...
public class DashboardAdminController {
    ...
    public void initialize() {
        ...
        Platform.runLater(() -> {
            ...
            try {
                java.net.URL bgUrl = getClass().getResource("/views/backgLIGHT.png");
                if (bgUrl != null) {
        ...
        Platform.runLater(() -> loadContent("/views/DashboardContent.fxml", "dashboard"));
    }
    ...
    void handleDashboard() {
        ...
        loadContent("/views/DashboardContent.fxml", "dashboard");
    }

    @FXML
    void handleGestionUsers() {
        if ("gestionUsers".equals(currentPage)) return;
        loadContent("/views/GestionUsersContent.fxml", "gestionUsers");
    }
