...
public class ValidationUtils {
    ...
    // =========================================================================
    //  Harmonie-specific helpers (used by meditation & journal controllers)
    // =========================================================================
    ...
    public static boolean isValidUrl(String url) {
        ...
        return url.trim().matches("^(https?://)?[a-zA-Z0-9.-]+\\.[a-zA-Z]{2,}(/.*)?$");
    }

    /** Returns an error message if the value is null/blank, otherwise null. */
    ...
    /** Returns an error message if value length is outside [min, max], otherwise null. */
    ...
    /** Returns an error message if value is not a positive integer, otherwise null. */
    ...
    /** Returns an error message if url is non-empty and malformed, otherwise null. */
    public static String getUrlError(String url) {
        if (isNullOrEmpty(url)) return null; // URL is optional for meditation sessions
