...
public class MyDataBase {
    ...
    final String URL = "jdbc:mysql://localhost:3306/integration-f?createDatabaseIfNotExist=false";
    ...
    // =========================================================================
    //  Ressource tables — salle, evenement, tache
    // =========================================================================

    private void initializeRessourceTables() {
        try {
            createRessourceTables();
            System.out.println("Ressource tables initialized.");
        } catch (SQLException e) {
            System.err.println("Error initializing Ressource tables: " + e.getMessage());
        }
    }

    private void createRessourceTables() throws SQLException {
        Statement stmt = cnx.createStatement();
        ...
        """);
        System.out.println("Table 'salle' ready.");
        ...
        stmt.execute("""
            CREATE TABLE IF NOT EXISTS evenement (
                ...
                salle_id            INT,
                statut_demande_salle VARCHAR(50),
                FOREIGN KEY (salle_id) REFERENCES salle(id) ON DELETE SET NULL
            )
        """);
        System.out.println("Table 'evenement' ready.");
        ...
        stmt.execute("""
            CREATE TABLE IF NOT EXISTS tache (
                ...
                deadline     DATETIME,
                notes        TEXT,
                statut_tache VARCHAR(50) NOT NULL DEFAULT 'A_FAIRE'
            )
        """);
        System.out.println("Table 'tache' ready.");
