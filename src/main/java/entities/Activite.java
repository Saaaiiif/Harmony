...
public class Activite {
    ...
    public Activite(int id_activite, Timestamp date_activite, int id_exercice, int duree_minutes, int calories_brulees, int nb_series, int nb_repetitions, float poids) {
    ...
    public Activite(Timestamp date_activite, int id_exercice, int duree_minutes, int calories_brulees, int nb_series, int nb_repetitions, float poids) {
        this.date_activite = date_activite;
        this.id_exercice = id_exercice;
        this.duree_minutes = duree_minutes;
        this.calories_brulees = calories_brulees;
    ...
    public String toString() {
        return "Activite{id=" + id_activite + ", date=" + date_activite + ", calories=" + calories_brulees + "}";
    }
}